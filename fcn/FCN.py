#修改数据集的路径就可以，然后读取数据集的.py文件的有些地方做小的调整即可。图像大小和格式都没有要求，因为预处理过程中全部resize为224*224了
...
tf.flags.DEFINE_integer("batch_size", "2", "batch size for training")   #batch 大小
tf.flags.DEFINE_string("logs_dir", "logs/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "Data_zoo/MIT_SceneParsing/", "path to dataset")  #数据存放的路径
tf.flags.DEFINE_float("learning_rate", "1e-4", "Learning rate for Adam Optimizer")   #学习率
tf.flags.DEFINE_string("model_dir", "Model_zoo/", "Path to vgg model mat")   #Vgg网络参数文件
tf.flags.DEFINE_bool('debug', "False", "Debug mode: True/ False")
tf.flags.DEFINE_string('mode', "train", "Mode train/ test/ visualize")    #训练模式Train|Visualize

MODEL_URL = 'http://www.vlfeat.org/matconvnet/models/beta16/imagenet-vgg-verydeep-19.mat'   #训练好的VggNet网络参数
...
#FCN的 网络结构定义，网络中用到的参数是迁移Vgg训练好的参数
